                    ...
                    <form method="POST" action="{{ route('public.account.register') }}">
                        ...
                        <div class="form-group mb-3">
                            <select id="type" name="type" class="form-control{{ $errors->has('type') ? ' is-invalid' : '' }}">
                                <option selected disabled value="">Type of User</option>    
                        ...
                        <div class="form-group">
                            <a class="btn btn-success btn-full fw6" href="{{ route('public.account.facebook.auth') }}" 
                                target="popup" 
                                onclick="window.open('{{ route('public.account.facebook.auth') }}','popup','width=600,height=600'); return false;">
                                    <i class="fab fa-facebook-f fa-fw"></i> {{ trans('plugins/real-estate::dashboard.facebook-register-cta') }}
                            </a>
                        </div>
